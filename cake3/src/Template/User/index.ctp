...
<body class="text-center">
	<form class="form-signin" action="http://0.0.0.0/cake3/User/select" method="post">
		...
		<a class="btn btn-lg btn-primary btn-block" href="http://0.0.0.0/cake3/User/register">新規登録</a>
		<a class="btn btn-lg btn-primary btn-block" href="http://0.0.0.0/cake3/User/reset">パスワードリセット</a>
